...
kategori = ['Content Rating','Category','Type','Genres']
playstore[kategori] = playstore[kategori].astype('category')
...
def index():
    ...
    content = pd.crosstab(index = df2['Content Rating'], columns = 'Total')
    content['Total'].plot(kind='pie')
